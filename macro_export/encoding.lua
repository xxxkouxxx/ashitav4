...
pcall(ffi.cdef, [[
    ...
    int WideCharToMultiByte(uint32_t CodePage, uint32_t dwFlags, wchar_t* lpWideCharString, int32_t cchWideChar, char* lpMultiByteStr, int32_t cbMultiByte, char* lpDefaultChar, int32_t* lpUsedDefaultChar);
]])
